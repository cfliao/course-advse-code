...
public class HTMLToolKit
{
    ...
    public static String createClassDetails(Class c)
    {
        ...
        for (int i = 0; constructors != null && i < constructors.length; i++)
        {
            ...
            text.append("</b>");
            text.append(getParametersAndExceptions(constructors[i].getParameterTypes(), constructors[i].getExceptionTypes()));
            text.append("<br>");
        }
        ...
        for (int i = 0; methods != null && i < methods.length; i++)
        {
            ...
            text.append("</b>");
            text.append(getParametersAndExceptions(methods[i].getParameterTypes(), methods[i].getExceptionTypes()));
            text.append("<br>");
        }
